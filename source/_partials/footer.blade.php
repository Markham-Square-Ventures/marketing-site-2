<footer id="contact" class="px-6 xl:px-8 py-24 bg-orange-50 relative overflow-hidden">
    <img src="/assets/images/lines.png" alt="Background lines"
        class="hidden lg:block absolute z-0 -right-4 top-24 w-80 h-auto">
    <div class="grid grid-cols-6 gap-20 xl:gap-0 lg:max-w-screen-2xl lg:mx-auto">
        <div
            ...
            <div>
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="https://www.linkedin.com/company/markham-square" target="_blank"
                        ...
                        <a href="https://www.instagram.com/team_markhamsq/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <rect x="36" y="36" width="184" height="184" rx="48"
                                    ...
                                    stroke-linejoin="round" stroke-width="12"></rect>
            ...
            <div>
                ...
                <p class="text-secondary text-gray-700 uppercase text-4 mt-6 font-light tracking-wide">&copy;
                    ...
                    Square
                    Ventures, LLC</p>
                <p class="text-secondary text-gray-700 uppercase text-4 mt-1 font-light tracking-wide">All Rights
                    Reserved
                </p>
            </div>
        </div>
        <div class="col-span-6 order-1 xl:order-2 xl:col-span-4 relative z-10">
            ...
            <form method="POST" action="https://forms.reform.app/headless/1e147r/untitled-form-1/104x26/submissions"
                ...
                <div class="flex flex-col">
                    <label for="1aeb9ecb-915d-45fd-9246-ee27278f0505"
                        class="font-primary text-gray-900 text-6 xl:text-7">
                        What's your name?
                    </label>
